...
object JwtUtils {
     ...
     * @return
     */
    fun parseJwt(secretKey: String = "", jwtStr: String): JwtPayload {
     ...
     * @return
     */
    fun parseJwtWithoutThrow(secretKey: String = "", jwtStr: String): Pair<JwtPayload?, ApiException?> {
        val jwt = try {
        ...
        val payload = JSONUtil.toBean(jwt.payloads, JwtPayload::class.java)
        if (!jwt.validate(0)) {
     ...
     * @return
     */
    fun generateJwt(secretKey: String, expireOffset: Int, payload: JwtPayload): String {
